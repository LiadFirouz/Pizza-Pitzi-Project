...
{
    public partial class frmManue : Form
    {
        ...
        DataTable Tsale;
        DataTable TsaleAssistence;
        public frmManue(string a, string b)
        {
            InitializeComponent();
            txtSaleCod.Text = a;
        ...
        private void frmManue_Load(object sender, EventArgs e)
        {
            ...
            Tsale = Class1.OpenTable("sales");
            TsaleAssistence = Class1.OpenTable("saleAssistance");
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dgv1.Rows.Count - 1; i++)
            {
                ...
                string strSql1 = "INSERT INTO saleAssistance(saleCode,productCode,amount,Price)";//הוספת פריטים לטבלת
                string strSql2 = "VALUES('" + o + "','" + p + "','" + q + "','" + u + "')";
                string strSqrl = strSql1 + strSql2;
                Class1.GetDataSet(strSqrl);

            }
            string str1 = "INSERT INTO sales(saleCode,customerCode,saleDate,salePrice,saleAmount)";//הוספת שורה  לטבלת ORDERS
            string str2 = "VALUES('" + txtSaleCod.Text + "','" + txtCustomerCod.Text + "','" + toDay.ToShortDateString() + "','" + txtNumOfItems.Text + "','" + txtTotalPrice.Text + "')";
            string str = str1 + str2;
            MessageBox.Show(GeneralUtilities.AddRecd(Tsale, str).ToString());
            Class1.GetDataSet("Select * from sales");
